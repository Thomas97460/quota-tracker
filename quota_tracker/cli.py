...
def build_parser() -> argparse.ArgumentParser:
    ...
    config_set.add_argument("--provider", choices=["gemini", "codex", "copilot"])
    ...
    scan.add_argument("--provider", choices=["all", "gemini", "codex", "copilot"], default="all")
    scan.add_argument("--full", action="store_true")
    probe = sub.add_parser("probe")
    probe.add_argument("--provider", choices=["all", "gemini", "codex", "copilot"], default="all")
